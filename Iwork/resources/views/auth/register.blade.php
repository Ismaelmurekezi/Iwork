<x-guest-layout>
    <h1 class="text-xl text-darkBlue font-bold pb-3 font-sans text-center">CREATE AN ACCOUNT</h1>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex mt-4">
            ...
            <x-primary-button class="w-[400px] mr-4 rounded-xl flex justify-center text-2xl font-bold">
                {{ __('Register') }}
            </x-primary-button>
        </div>
    </form>
