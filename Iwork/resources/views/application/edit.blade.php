...
<form action="/application/{{ $application->id }}"  method="POST" enctype="multipart/form-data">
   ...
   <div class="mb-6">
       ...
       <input type="number" class="border border-gray-400  rounded-lg p-2 w-full" name="age"
         placeholder="Enter your age" value="{{$application->age}}" />
   ...
   <div class="mb-6">
     ...
     <input type="text" class="border border-gray-400  rounded-lg p-2 w-full" name="location"
       placeholder="Your location" value="{{$application->location}}" />
   ...
   <div class="mb-6">
     ...
     <input type="text" class="border border-gray-400  rounded-lg p-2 w-full" name="email" value="{{$application->email}}" />
   ...
   <div class="mb-6">
      ...
      Telephone Number
       ...
       <input type="text" class="border border-gray-400  rounded-lg p-2 w-full" name="telephone" value="{{$application->telephone}}" />
...
Skills (Comma Separated)
     ...
     <input type="text" class="border border-gray-400  rounded-lg p-2 w-full" name="skills"
       placeholder="Your skills" value="{{$application->skills}}" />
   ...
   <div class="mb-6  ">
     <input type="submit" class="w-full mt-7 font-bold text-white border-2 bg-lightBlue rounded-xl py-2 px-4 hover:bg-blue-400" value="Update"/>
 
     <button class="w-full mt-3 font-bold border-lightBlue border-2  rounded-xl py-2 px-4  hover:bg-blue-400 ">
       <a href="/applications" class=" text-lightBlue ml-4 hover:text-white"> Back </a>
     </button>
